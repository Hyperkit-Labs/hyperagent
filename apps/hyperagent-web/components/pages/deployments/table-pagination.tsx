...
interface DeploymentTablePaginationProps {
  currentPage: number;
  totalPages: number;
  totalResults: number;
...
export const DeploymentTablePagination: React.FC<DeploymentTablePaginationProps> = ({
  currentPage,
  totalPages,
  totalResults,
  resultsPerPage,
  ...
  return (
    <div className="mt-auto border-t border-white/5 px-6 py-4 flex items-center justify-between">
      <div className="text-xs text-slate-500">
        ...
        <span className="font-medium text-slate-300">{totalResults}</span> deployments
      </div>
