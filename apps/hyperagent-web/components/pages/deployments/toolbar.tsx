...
export const DeploymentsToolbar: React.FC<DeploymentsToolbarProps> = ({
  searchQuery,
  onSearchChange,
  selectedEnv,
  onEnvChange,
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 mb-6">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 sm:pb-0">
        ...
        {/* Refresh Button */}
        <button className="flex items-center justify-center w-9 h-9 text-slate-300 bg-white/[0.08] border border-white/10 rounded-md transition-all hover:text-white">
