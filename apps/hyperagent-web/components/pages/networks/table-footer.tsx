...
export const NetworkTableFooter: React.FC<NetworkTableFooterProps> = ({ totalNetworks }) => {
  return (
    <div className="mt-auto border-t border-white/5 px-6 py-4 flex items-center justify-between">
      <div className="text-xs text-slate-500">
        Showing <span className="font-medium text-slate-300">{totalNetworks}</span> configured
        networks
      </div>
