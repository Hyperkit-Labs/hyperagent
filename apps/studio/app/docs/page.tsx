...
function buildGuides(apiDocsUrl: string | null) {
  return [
    ...
    },
    {
      icon: Terminal,
      title: "CLI reference",
      desc: "API client and programmatic access via TypeScript SDK",
      href: apiDocsUrl,
      external: true,
    },
  ];
      ...
      <div className="p-6 lg:p-8">
        <div className="max-w-[1200px] mx-auto space-y-6 animate-enter">
          <div className="flex items-center gap-3">
            ...
            <PageTitle
              title="Documentation"
              subtitle="Guides, API reference, and platform resources"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-[var(--color-text-tertiary)] text-sm mt-1">
                  Interactive OpenAPI docs with request/response examples.
                </p>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div>
                ...
                <p className="text-[var(--color-text-tertiary)] text-sm mt-1">
                  Source code, issues, and contributing guidelines.
                </p>
              </div>
            </a>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {buildGuides(apiDocsUrl).map((g) => {
                ...
                const inner = (
                  <div
                    className={`glass-panel rounded-lg p-4 flex items-start gap-3 h-full ${g.href ? "glass-panel-hover transition-all" : "opacity-70"}`}
                  >
                ...
                if (!g.href) {
                  return (
                    <div key={g.title} className="pointer-events-none">
                      {inner}
                    </div>
                  );
                }
