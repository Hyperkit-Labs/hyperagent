...
export default function DomainsPage() {
  ...
  const {
    ...
    isLoading,
    mutate,
  } = useSWR<DomainRecord[]>(tab === "domains" ? "domains" : null, () =>
    listDomains(),
  );
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <PageTitle
              ...
              subtitle="Manage domains, certificates, and deployment infrastructure"
            />
          </div>
          <button
            type="button"
                ...
                {[
                  {
                    name: "Vercel",
                    status: "available",
                    desc: "Frontend hosting for Next.js dApps",
                  },
                  {
                    name: "IPFS / Pinata",
                    status: "available",
                    desc: "Decentralized hosting for static dApps",
                  },
                  {
                    name: "Docker",
                    status: "requires setup",
                    desc: "Container deployments for backend services",
                  },
                  {
                    name: "Custom Server",
                    status: "requires setup",
                    desc: "Deploy to your own infrastructure",
                  },
                ].map((target) => (
                  <div
                    key={target.name}
                    className="glass-panel glass-panel-hover rounded-lg p-4"
                  >
