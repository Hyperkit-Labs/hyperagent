  ...
  const fetchData = useCallback(() => {
    ...
    if (tab === "workflows") {
      getWorkflows({ limit: 100 })
        .then((r) =>
          setWorkflows((r as { workflows?: WorkflowItem[] }).workflows || []),
        )
        .catch((e) =>
      ...
      getLogs({ page_size: 100 })
        .then((r) =>
          setLogs(
            Array.isArray(r) ? r : (r as { logs?: LogEntry[] }).logs || [],
          ),
        )
        .catch((e) =>
      ...
      <div className="p-6 lg:p-8 max-w-[1200px] mx-auto space-y-6 animate-enter">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <PageTitle
              title="History"
              subtitle="Browse past workflows, runs, and log entries"
            />
          </div>
        </div>
            ...
            {filteredLogs.map((log, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-[var(--color-text-primary)] font-mono break-words">
                    {log.message}
                  </p>
