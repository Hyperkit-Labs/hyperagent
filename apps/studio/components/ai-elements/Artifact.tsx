...
export function ArtifactHeader({
  ...
  return (
    <div
      className={`flex items-center justify-between gap-4 p-4 border-b border-[var(--color-border-subtle)] bg-[var(--color-bg-panel)] ${className}`}
    >
      {children}
    </div>
  );
...
export function ArtifactTitle({
  ...
  return (
    <h3
      className={`text-lg font-bold text-[var(--color-text-primary)] truncate ${className}`}
    >
      {children}
    </h3>
  );
...
export function ArtifactDescription({
  ...
  return (
    <span
      className={`text-sm text-[var(--color-text-tertiary)] truncate hidden sm:inline ${className}`}
    >
      {children}
    </span>
  );
