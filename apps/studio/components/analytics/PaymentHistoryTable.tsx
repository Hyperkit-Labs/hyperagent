...
export function PaymentHistoryTable({
  ...
  if (history.length === 0) {
    return (
      <div className="glass-panel rounded-lg p-8 text-center text-[var(--color-text-muted)]" role="status">
  ...
  return (
    <div className="glass-panel rounded-lg overflow-hidden">
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-[var(--color-border)]" aria-label="Payment history">
          <thead className="bg-[var(--color-bg-panel)]">
            <tr>
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-[var(--color-text-tertiary)] uppercase tracking-wider">
                Date
              </th>
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-[var(--color-text-tertiary)] uppercase tracking-wider">
                Amount
          ...
          <tbody className="divide-y divide-[var(--color-border)]">
            {history.map((item) => (
              <tr key={item.id} className="hover:bg-[var(--color-bg-panel)] transition-colors">
