  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 inset-x-0 h-8 bg-transparent flex items-center px-3 gap-1.5 z-10">
        ...
        <div className="ml-auto text-[10px] font-mono text-[var(--color-text-muted)] tracking-wider opacity-60">
          hyperagent.exe
        </div>
      </div>
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="text-sm text-[var(--color-text-secondary)] font-mono drop-shadow-[0_0_8px_rgba(255,255,255,0.2)]">
                  ...
                  <motion.span
                    ...
                    className="inline-block w-2 h-4 bg-[var(--color-primary)] ml-1 align-middle shadow-[0_0_8px_var(--color-primary)]"
                  />
                </div>
                <div className="absolute -top-1 right-0">
                  <div className="px-3 py-1 rounded-md bg-[var(--color-bg-base)] text-[var(--color-primary-light)] text-[10px] font-semibold shadow-[3px_3px_6px_#000000,-3px_-3px_6px_#1a1a24] border border-white/5">
                    Generate
                  </div>
                </div>
              </motion.div>
            ...
            {step === 1 && (
              ...
              >
                <div className="flex items-center gap-2 text-[var(--color-semantic-info)] mb-2 mt-1">
                  ...
                  <span className="text-xs font-semibold uppercase tracking-wider drop-shadow-md">
                    Codegen
                  </span>
                </div>
                <div className="text-[10px] font-mono text-[var(--color-text-secondary)] space-y-1 mt-1">
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{ width: "100%" }}
                    className="overflow-hidden whitespace-nowrap text-[var(--color-primary-light)] drop-shadow-[0_0_2px_var(--color-primary-alpha-50)]"
                  >
                    contract Vault {"{"}
                  </motion.div>
                  <motion.div
                    ...
                    className="overflow-hidden whitespace-nowrap pl-4 opacity-80"
                  >
                  ...
                  <motion.div
                    ...
                    className="overflow-hidden whitespace-nowrap pl-4 text-[var(--color-semantic-info)]"
                  >
                  ...
                  <motion.div
                    ...
                    className="overflow-hidden whitespace-nowrap pl-8"
                  >
                ...
                <div className="absolute -top-1 right-0">
                  <div className="px-3 py-1 rounded-md bg-[var(--color-bg-base)] text-[var(--color-semantic-info)] text-[10px] font-semibold shadow-[3px_3px_6px_#000000,-3px_-3px_6px_#1a1a24] border border-white/5">
                    Audit
                  </div>
                </div>
              </motion.div>
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="absolute -top-1 right-0">
                  <div className="px-3 py-1 rounded-md bg-[var(--color-bg-base)] text-[var(--color-semantic-warning)] text-[10px] font-semibold shadow-[3px_3px_6px_#000000,-3px_-3px_6px_#1a1a24] border border-white/5">
                    Deploy
                  </div>
                </div>
              </motion.div>
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="text-sm font-medium text-[var(--color-semantic-success)] mb-1 drop-shadow-md">
      ...
      >
        ...
        >
          <path
            d="M5.5 3L19.5 12L12 13.5L8.5 21L5.5 3Z"
            fill="#a78bfa"
            stroke="white"
            strokeWidth="1.5"
