...
interface MetricsApiResponse {
  ...
  security?: { score?: number; open_risks?: { critical?: number; high?: number; medium?: number; low?: number }; audit_coverage?: number };
  performance?: { avg_latency?: number; total_invocations?: number; success_rate?: number; gas_consumption?: number };
}
