...
| [glossary.md](glossary.md) | Definitions with "use when / do not use when" guidance |
...
Concept docs to read alongside the map: [agents.md](agents.md), [commands.md](commands.md), [bridge.md](bridge.md), and [state-boundaries.md](state-boundaries.md).

---

## Related project docs

- [Contributor guide](../contributing/developer-guide.md) - local setup and repository navigation
- `CLAUDE.md` in the repository root - project constitution and stack
