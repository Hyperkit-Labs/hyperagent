# Issue #178: Design Supabase schema for workspaces, projects, runs, artefacts
...
**Type**: feature  
**Area**: storage-rag  
**GitHub**: https://github.com/Hyperkit-Labs/hyperagent/issues/178  
**Created**: 2026-02-06T08:50:39Z  
**Updated**: 2026-02-06T14:04:18Z
...
**Task Title:**  
> Design Supabase schema for workspaces, projects, runs, artefacts

**Primary Goal:**  
> Design and document supabase schema for workspaces, projects, runs, artefacts following best practices

**User Story / Context:**  
> As a platform user, I want design supabase schema for workspaces, projects, runs, artefacts so that the system operates reliably
...
---
*Last synced: 2026-02-06T23:12:26.620447*
