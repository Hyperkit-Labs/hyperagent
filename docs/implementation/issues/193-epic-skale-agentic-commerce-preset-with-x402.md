# Issue #193: Epic: SKALE Agentic Commerce preset with x402
...
**Type**: epic  
**Area**: chain-adapter  
**GitHub**: https://github.com/Hyperkit-Labs/hyperagent/issues/193  
**Created**: 2026-02-06T08:52:00Z  
**Updated**: 2026-02-06T14:03:43Z
...
**Task Title:**  
> Epic: SKALE Agentic Commerce preset with x402

**Primary Goal:**  
> Complete epic: skale agentic commerce preset with x402 to enable Phase 1 Foundation goals

**User Story / Context:**  
> As a developer/user, I want epic: skale agentic commerce preset with x402 so that HyperAgent functions as designed

**Business Impact:**  
> enables deployment to skale, supports skale-commerce preset functionality, critical for Phase 1 MVP delivery
...
- [ ] Related skale-commerce preset components

**Technical Constraints:**
> This epic may span multiple sprints; Related issues should be tracked separately; Focus on skale chain integration; Part of skale-commerce preset implementation
...
- `SKALE_RPC_URL=` (get from internal vault)
