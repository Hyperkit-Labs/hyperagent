# Issue #198: Epic: Frontend shell & run view
...
**Type**: epic  
**Area**: frontend  
**GitHub**: https://github.com/Hyperkit-Labs/hyperagent/issues/198  
**Created**: 2026-02-06T08:52:31Z  
**Updated**: 2026-02-06T14:03:32Z
...
**Task Title:**  
> Epic: Frontend shell & run view

**Primary Goal:**  
> Complete epic: frontend shell & run view to enable Phase 1 Foundation goals

**User Story / Context:**  
> As a user, I want epic: frontend shell & run view so that I can effectively use HyperAgent features

**Business Impact:**  
> improves user experience and onboarding, critical for Phase 1 MVP delivery
...
> This epic may span multiple sprints; Related issues should be tracked separately; Out of scope: Backend API changes (track separately)
...
- Frontend repo: `hyperagent/apps/web/`
