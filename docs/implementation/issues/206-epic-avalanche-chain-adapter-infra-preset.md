# Issue #206: Epic: Avalanche chain adapter & Infra preset
...
**Type**: epic  
**Area**: chain-adapter  
**GitHub**: https://github.com/Hyperkit-Labs/hyperagent/issues/206  
**Created**: 2026-02-06T08:53:15Z  
**Updated**: 2026-02-06T14:03:15Z
...
**Task Title:**  
> Epic: Avalanche chain adapter & Infra preset

**Primary Goal:**  
> Complete epic: avalanche chain adapter & infra preset to enable Phase 1 Foundation goals

**User Story / Context:**  
> As a developer/user, I want epic: avalanche chain adapter & infra preset so that HyperAgent functions as designed

**Business Impact:**  
> enables deployment to avalanche, supports avax-infra preset functionality, critical for Phase 1 MVP delivery
...
- [ ] Related avax-infra preset components

**Technical Constraints:**
> This epic may span multiple sprints; Related issues should be tracked separately; Focus on avalanche chain integration; Part of avax-infra preset implementation
...
- `AVALANCHE_RPC_URL=` (get from internal vault)
