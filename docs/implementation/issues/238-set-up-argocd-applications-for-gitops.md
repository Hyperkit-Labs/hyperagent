# Issue #238: Set up ArgoCD applications for GitOps
...
**Type**: feature  
**Area**: infra  
**GitHub**: https://github.com/Hyperkit-Labs/hyperagent/issues/238  
**Created**: 2026-02-06T13:44:32Z  
**Updated**: 2026-02-06T14:02:03Z
...
**Primary Goal:**  
> Set up and configure set up argocd applications for gitops for use in HyperAgent

**User Story / Context:**  
> As a developer/user, I want set up argocd applications for gitops so that HyperAgent functions as designed
