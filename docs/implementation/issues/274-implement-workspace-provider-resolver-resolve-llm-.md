# Issue #274: Implement workspace provider resolver (resolve LLM keys, Tenderly, RPC from workspace_providers table)
...
**Type**: feature  
**Area**: orchestration  
**GitHub**: https://github.com/Hyperkit-Labs/hyperagent/issues/274  
**Created**: 2026-02-06T14:24:28Z  
**Updated**: 2026-02-06T14:24:28Z
...
**User Story / Context:**  
> As a platform user, I want implement workspace provider resolver (resolve llm keys, tenderly, rpc from workspace_providers table) so that the system operates reliably
...
---
*Last synced: 2026-02-06T23:12:26.618292*
