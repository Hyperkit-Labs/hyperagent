...
interface SecurityAlertTableFooterProps {
  totalAlerts: number;
}

export const SecurityAlertTableFooter: React.FC<SecurityAlertTableFooterProps> = ({
  totalAlerts,
}) => {
  return (
    <div className="mt-auto border-t border-white/5 px-6 py-4 flex items-center justify-between">
      <div className="text-xs text-slate-500">
        Showing <span className="font-medium text-slate-300">{totalAlerts}</span> recent alerts
      </div>
