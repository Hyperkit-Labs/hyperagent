...
export type RunPlanStepType = "spec" | "design" | "codegen" | "audit" | "simulation" | "deploy" | "ui_scaffold";
 ...
 */
export declare const ERC8004_ADDRESSES: {
    readonly SKALE_BASE_SEPOLIA: "0x8004A818BFB912233c491871b3d84c89A494BD9e";
};
export declare const ERC8004_CHAIN_IDS: {
    readonly SKALE_BASE_SEPOLIA: 324705682;
};
export type LLMProvider = "openai" | "anthropic" | "google";
export declare const LLM_PROVIDERS: readonly LLMProvider[];
...
export declare function detectProviderFromKey(raw: string): LLMProvider | null;
 ...
 */
export declare class KeyMaterial {
    #private;
