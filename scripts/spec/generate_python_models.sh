...
SCHEMA_FILE="$ROOT_DIR/schema/hyperagent_state.schema.json"
OUT_DIR="$ROOT_DIR/hyperagent/core/generated_spec"
...
echo "Wrote: hyperagent/core/generated_spec/hyperagent_state.py"
