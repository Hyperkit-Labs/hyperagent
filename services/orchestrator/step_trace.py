...
@asynccontextmanager
async def step_span(run_id: str, step_type: str, step_index: int) -> AsyncIterator[None]:
    """
    ...
    logger.info(
        ...
        run_id, step_type, step_index, step_id,
        extra={"run_id": run_id, "step_type": step_type, "step_index": step_index, "step_id": step_id},
    )
    try:
        yield
    finally:
