"""Canonical Spec Lock contract and export helpers.

This is the Python-side source of truth for the structured spec payload used by
ROMA, orchestrator fallback flows, and downstream contract mirrors.
"""
